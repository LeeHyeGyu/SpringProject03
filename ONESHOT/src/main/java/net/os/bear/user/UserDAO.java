...
public interface UserDAO {
	...
	List<MyPageDTO> getMSGList(MyPageDTO mypageDTO) throws SQLException;
	...
	void recvDelete(MsgDTO msgDTO) throws SQLException;

	void sendDelete(MsgDTO msgDTO) throws SQLException;

	void realDelete() throws SQLException;
